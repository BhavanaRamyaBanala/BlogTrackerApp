...
namespace BlogTracker.Controllers
{
    public class EmpInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Email,Name,DateOfJoining,PassCode")] EmpInfo empInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Email,Name,DateOfJoining,PassCode")] EmpInfo empInfo)
        {
            if (ModelState.IsValid)
            {
